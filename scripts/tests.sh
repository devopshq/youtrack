...
assert "get_url_travis_build_status develop" "https://travis-ci.org/devopshq/youtrack.svg?branch=develop"
...
function git() {
    # emulate: git tag -l TAG_NAME
    [ "$*" = "tag -a v1.0 -mbuild log https://travis-ci.org/devopshq/youtrack/builds/100500" ]
}
