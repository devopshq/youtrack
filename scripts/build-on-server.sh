...
DEVOPS_BUILD_VERSION_FROM_FILE="$(extract_version_from_file youtrack/__init__.py)"
...
if bool "$DEVOPS_BUILD_DEVELOP"; then
    ...
    version_append_build_number "youtrack/__init__.py" "dev${DEVOPS_BUILD_NUMBER}"

    DEVOPS_BUILD_VERSION="$(extract_version_from_file youtrack/__init__.py)"
